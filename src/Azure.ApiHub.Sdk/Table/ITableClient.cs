...
namespace Microsoft.Azure.ApiHub
{
    ...
    public interface ITableClient
    {
        ...
        Task<SegmentedResult<IDataSet>> ListDataSetsAsync(Query query = null, ContinuationToken continuationToken = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
